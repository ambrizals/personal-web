	...
	<div class="col-md-3">
		<div class="card">
			...
			<div class="list-group list-group-flush">
				...
				<a href="{{ url('panel/article') }}" class="list-group-item list-group-item-action active">Daftar Artikel</a>
		...
		<div class="card">
			...
			<div class="list-group list-group-flush">
				...
				<a href="{{ url('panel/category') }}" class="list-group-item list-group-item-action">Daftar Kategori</a>
